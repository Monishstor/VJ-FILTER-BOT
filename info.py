...
API_ID = int(environ.get('API_ID', '27984155'))
API_HASH = environ.get('API_HASH', 'e6ce4c58aa81eac02e4f558c06820e54')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002091131128'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1258250668').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002082713979').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002101414617').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://zahiraparveenbusiness:<1Yg4Q2pqiFTgGkHQ>@monish22.mhgzdp0.mongodb.net/?retryWrites=true&w=majority&appName=Monish22")
